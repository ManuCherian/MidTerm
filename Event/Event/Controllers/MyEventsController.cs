...
namespace Event.Controllers
{
    public class MyEventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Event_id,Event_Title,Location")] MyEvent myEvent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Event_id,Event_Title,Location")] MyEvent myEvent)
        {
            if (ModelState.IsValid)
            {
